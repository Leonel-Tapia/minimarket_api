# app/routes/proveedores_compras.py
...
async def registrar_compra(
    ...
    try:
        ...
        conn.commit()
        # 🔹 Ajuste: incluir numero_factura en la redirección
        return RedirectResponse(
            url=f"/comprasdetalle/registrar?id_compra={id_compra}&id_proveedor={id_proveedor}&numero_factura={numero_factura}",
            status_code=303
        )
    except Exception as e:
